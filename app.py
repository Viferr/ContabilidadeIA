...
#---------
        ...
        with col1:
            ...
            st.markdown(f'<div style="text-align: center; font-family: sans-serif; max-width: 140px; margin: 0 auto;"><h4 style="color: #1E88E5; margin-bottom: 8px; font-size: 0.85rem; min-height: 45px; display: flex; align-items: center; justify-content: center;background-color: #F5F5F5;">{nome_conta_debito}</h4><div style="display: flex; justify-content: space-between; font-weight: bold; font-size: 0.75rem; color: #222222; padding-bottom: 3px; border-bottom: 3px solid #222222;"><span>D</span><span>C</span></div><div style="display: flex; justify-content: space-between; height: 28px; align-items: center;"><span style="width: 50%; text-align: left; padding-left: 2px; color: #222222; font-weight: bold; border-right: 2px solid #222222; height: 100%; display: flex; align-items: center;">{val_d}</span><span style="width: 50%; text-align: right; padding-right: 2px; color: #222222; font-weight: bold; height: 100%; display: flex; align-items: center; justify-content: flex-end;">{val_c}</span></div></div>', unsafe_allow_html=True)
        ...
        with col2:
            ...
            st.markdown(f'<div style="text-align: center; font-family: sans-serif; max-width: 140px; margin: 0 auto;"><h4 style="color: #1E88E5; margin-bottom: 8px; font-size: 0.85rem; min-height: 45px; display: flex; align-items: center; justify-content: center;background-color: #F5F5F5;">{nome_conta_iva}</h4><div style="display: flex; justify-content: space-between; font-weight: bold; font-size: 0.75rem; color: #222222; padding-bottom: 3px; border-bottom: 3px solid #222222;"><span>D</span><span>C</span></div><div style="display: flex; justify-content: space-between; height: 28px; align-items: center;"><span style="width: 50%; text-align: left; padding-left: 2px; color: #222222; font-weight: bold; border-right: 2px solid #222222; height: 100%; display: flex; align-items: center;">{val_iva_d}</span><span style="width: 50%; text-align: right; padding-right: 2px; color: #222222; font-weight: bold; height: 100%; display: flex; align-items: center; justify-content: flex-end;">{val_iva_c}</span></div></div>', unsafe_allow_html=True)


        # 🟢 INJETA O RAZONETE DA RETENÇÃO SE ELE ESTIVER ATIVO:
        if col_ret is not None:
            with col_ret:
                st.markdown(f'<div style="text-align: center; font-family: sans-serif; max-width: 140px; margin: 0 auto;"><h4 style="color: #1E88E5; margin-bottom: 8px; font-size: 0.85rem; min-height: 45px; display: flex; align-items: center; justify-content: center;background-color: #F5F5F5;">Conta 2413<br>Retenção Fonte IRC</h4><div style="display: flex; justify-content: space-between; font-weight: bold; font-size: 0.75rem; color: #222222; padding-bottom: 3px; border-bottom: 3px solid #222222;"><span>D</span><span>C</span></div><div style="display: flex; justify-content: space-between; height: 28px; align-items: center;"><span style="width: 50%; text-align: left; padding-left: 2px; color: #222222; font-weight: bold; border-right: 2px solid #222222; height: 100%; display: flex; align-items: center;">{retencao_fatura_desenho}€</span><span style="width: 50%;"></span></div></div>', unsafe_allow_html=True)

        with col3:
            val_tot_d = f"{total_documento}€" if not contrapartida_credito else ""
            val_tot_c = f"{total_documento}€" if contrapartida_credito else ""
            st.markdown(f'<div style="text-align: center; font-family: sans-serif; max-width: 140px; margin: 0 auto;"><h4 style="color: #E53935; margin-bottom: 8px; font-size: 0.85rem; min-height: 45px; display: flex; align-items: center; justify-content: center;background-color: #F5F5F5;">{nome_conta_contrapartida}</h4><div style="display: flex; justify-content: space-between; font-weight: bold; font-size: 0.75rem; color: #222222; padding-bottom: 3px; border-bottom: 3px solid #222222;"><span>D</span><span>C</span></div><div style="display: flex; justify-content: space-between; height: 28px; align-items: center;"><span style="width: 50%; text-align: left; padding-left: 2px; color: #222222; font-weight: bold; border-right: 2px solid #222222; height: 100%; display: flex; align-items: center;">{val_tot_d}</span><span style="width: 50%; text-align: right; padding-right: 2px; color: #222222; font-weight: bold; height: 100%; display: flex; align-items: center; justify-content: flex-end;">{val_tot_c}</span></div></div>', unsafe_allow_html=True)
...
# --- DICIONÁRIO DE CONSULTA PÚBLICA (Fica na Aba 1) ---
    ...
    with st.expander("🦅 Abrir Painel de Encerramento e Apuramento de IRC"):
        ...
        with col_r8_1:
            ...
            st.markdown(f'<div style="text-align: center; font-family: sans-serif; max-width: 140px; margin: 0 auto;"><h4 style="color: #1E88E5; margin-bottom: 8px; font-size: 0.85rem; min-height: 45px; display: flex; align-items: center; justify-content: center;">811 - Resultado Antes de Impostos</h4><div style="display: flex; justify-content: space-between; font-weight: bold; font-size: 0.75rem; color: #222222; padding-bottom: 3px; border-bottom: 3px solid #222222;"><span>D</span><span>C</span></div><div style="display: flex; justify-content: space-between; height: 28px; align-items: center;"><span style="width: 50%; text-align: left; padding-left: 2px; color: #222222; font-weight: bold; border-right: 2px solid #222222; height: 100%; display: flex; align-items: center;">{v_rai_d}</span><span style="width: 50%; text-align: right; padding-right: 2px; color: #222222; font-weight: bold; height: 100%; display: flex; align-items: center; justify-content: flex-end;">{v_rai_c}</span></div></div>', unsafe_allow_html=True)

        with col_r8_2:
            v_irc_d = f"{irc_estimado}€" if irc_estimado > 0 else ""
            st.markdown(f'<div style="text-align: center; font-family: sans-serif; max-width: 140px; margin: 0 auto;"><h4 style="color: #E53935; margin-bottom: 8px; font-size: 0.85rem; min-height: 45px; display: flex; align-items: center; justify-content: center;">8121 - IRC do Período</h4><div style="display: flex; justify-content: space-between; font-weight: bold; font-size: 0.75rem; color: #222222; padding-bottom: 3px; border-bottom: 3px solid #222222;"><span>D</span><span>C</span></div><div style="display: flex; justify-content: space-between; height: 28px; align-items: center;"><span style="width: 50%; text-align: left; padding-left: 2px; color: #222222; font-weight: bold; border-right: 2px solid #222222; height: 100%; display: flex; align-items: center;">{v_irc_d}</span><span style="width: 50%;"></span></div></div>', unsafe_allow_html=True)
        ...
        with col_r8_3:
            ...
            st.markdown(f'<div style="text-align: center; font-family: sans-serif; max-width: 140px; margin: 0 auto;"><h4 style="color: #4CAF50; margin-bottom: 8px; font-size: 0.85rem; min-height: 45px; display: flex; align-items: center; justify-content: center;">818 - Resultado Líquido do Período</h4><div style="display: flex; justify-content: space-between; font-weight: bold; font-size: 0.75rem; color: #222222; padding-bottom: 3px; border-bottom: 3px solid #222222;"><span>D</span><span>C</span></div><div style="display: flex; justify-content: space-between; height: 28px; align-items: center;"><span style="width: 50%; text-align: left; padding-left: 2px; color: #222222; font-weight: bold; border-right: 2px solid #222222; height: 100%; display: flex; align-items: center;">{v_rl_d}</span><span style="width: 50%; text-align: right; padding-right: 2px; color: #222222; font-weight: bold; height: 100%; display: flex; align-items: center; justify-content: flex-end;">{v_rl_c}</span></div></div>', unsafe_allow_html=True)
...
with aba2:
    ...
    with col_sal_t1:
        ...
        st.markdown(f'<div style="text-align: center; font-family: sans-serif; max-width: 160px; margin: 0 auto 15px auto;"><h4 style="color: #1E88E5; margin-bottom: 8px; font-size: 0.85rem; min-height: 40px;">631 - Remunerações do Pessoal</h4><div style="display: flex; justify-content: space-between; font-weight: bold; font-size: 0.75rem; color: #222222; border-bottom: 3px solid #222222;"><span>D</span><span>C</span></div><div style="display: flex; justify-content: space-between; height: 28px; align-items: center;"><span style="width: 50%; text-align: left; color: #222222; font-weight: bold; border-right: 2px solid #222222; height: 100%;">{salario_base}€</span><span style="width: 50%;"></span></div></div>', unsafe_allow_html=True)
        # Gasto com TSU da Empresa
        st.markdown(f'<div style="text-align: center; font-family: sans-serif; max-width: 160px; margin: 0 auto;"><h4 style="color: #1E88E5; margin-bottom: 8px; font-size: 0.85rem; min-height: 40px;">635 - Encargos sobre Remunerações</h4><div style="display: flex; justify-content: space-between; font-weight: bold; font-size: 0.75rem; color: #222222; border-bottom: 3px solid #222222;"><span>D</span><span>C</span></div><div style="display: flex; justify-content: space-between; height: 28px; align-items: center;"><span style="width: 50%; text-align: left; color: #222222; font-weight: bold; border-right: 2px solid #222222; height: 100%;">{encargo_ss_empresa}€</span><span style="width: 50%;"></span></div></div>', unsafe_allow_html=True)

    with col_sal_t2:
        st.markdown("##### 🔻 Contas de Passivo / Dívida (Crédito)")
        # Dívida ao Trabalhador (Valor Líquido + Subsídio Refeição)
        st.markdown(f'<div style="text-align: center; font-family: sans-serif; max-width: 160px; margin: 0 auto 15px auto;"><h4 style="color: #E53935; margin-bottom: 8px; font-size: 0.85rem; min-height: 40px;">231 - Pessoal (Líquido a Pagar)</h4><div style="display: flex; justify-content: space-between; font-weight: bold; font-size: 0.75rem; color: #222222; border-bottom: 3px solid #222222;"><span>D</span><span>C</span></div><div style="display: flex; justify-content: space-between; height: 28px; align-items: center;"><span style="width: 50%; border-right: 2px solid #222222; height: 100%;"></span><span style="width: 50%; text-align: right; color: #222222; font-weight: bold;">{salario_liquido}€</span></div></div>', unsafe_allow_html=True)
        # Dívida à Segurança Social (Trabalhador + Empresa)
        st.markdown(f'<div style="text-align: center; font-family: sans-serif; max-width: 160px; margin: 0 auto 15px auto;"><h4 style="color: #E53935; margin-bottom: 8px; font-size: 0.85rem; min-height: 40px;">245 - Estado (Segurança Social)</h4><div style="display: flex; justify-content: space-between; font-weight: bold; font-size: 0.75rem; color: #222222; border-bottom: 3px solid #222222;"><span>D</span><span>C</span></div><div style="display: flex; justify-content: space-between; height: 28px; align-items: center;"><span style="width: 50%; border-right: 2px solid #222222; height: 100%;"></span><span style="width: 50%; text-align: right; color: #222222; font-weight: bold;">{total_seg_social_estado}€</span></div></div>', unsafe_allow_html=True)
        # Retenção de IRS do Trabalhador
        st.markdown(f'<div style="text-align: center; font-family: sans-serif; max-width: 160px; margin: 0 auto;"><h4 style="color: #E53935; margin-bottom: 8px; font-size: 0.85rem; min-height: 40px;">242 - Estado (Retenção IRS)</h4><div style="display: flex; justify-content: space-between; font-weight: bold; font-size: 0.75rem; color: #222222; border-bottom: 3px solid #222222;"><span>D</span><span>C</span></div><div style="display: flex; justify-content: space-between; height: 28px; align-items: center;"><span style="width: 50%; border-right: 2px solid #222222; height: 100%;"></span><span style="width: 50%; text-align: right; color: #222222; font-weight: bold;">{desconto_irs_trabalhador}€</span></div></div>', unsafe_allow_html=True)
